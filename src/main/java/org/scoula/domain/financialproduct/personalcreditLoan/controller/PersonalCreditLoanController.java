...
public class PersonalCreditLoanController {
    ...
    public SuccessResponse<PersonalCreditLoanDTO> getPersonalCreditLoanById(
        ...
        PersonalCreditLoanDTO personalCreditLoanDTO = personalCreditLoanService.getPersonalCreditLoanById(personalCreditLoanId);
    ...
    public SuccessResponse<List<PersonalCreditLoanDTO>> getPersonalCreditLoansByFinancialCompany(
        ...
        List<PersonalCreditLoanDTO> personalCreditLoans = personalCreditLoanService.getPersonalCreditLoansByFinancialCompanyId(financialCompanyId);
    ...
    public SuccessResponse<List<PersonalCreditLoanDTO>> getPersonalCreditLoansByProductType(
        ...
        List<PersonalCreditLoanDTO> personalCreditLoans = personalCreditLoanService.getPersonalCreditLoansByCrdtPrdtTypeNm(crdtPrdtTypeNm);
